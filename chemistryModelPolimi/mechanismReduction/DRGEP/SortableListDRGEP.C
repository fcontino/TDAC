...
template <class Type>
Foam::SortableListDRGEP<Type>::SortableListDRGEP(const label size, const Type& val)
:
    List<Type>(size, val),
    indices_(size)
{}
...
// Construct as copy.
template <class Type>
Foam::SortableListDRGEP<Type>::SortableListDRGEP(const SortableListDRGEP<Type>& lst)
:
    List<Type>(lst),
...
void Foam::SortableListDRGEP<Type>::partialSort(int M)
{
    ...
    std::partial_sort(indices_.begin(), indices_.begin()+M, indices_.end(),less(*this));
/*
    List<Type> tmpValues(this->size());
...
template <class Type>
void Foam::SortableListDRGEP<Type>::operator=(const SortableListDRGEP<Type>& rhs)
{
