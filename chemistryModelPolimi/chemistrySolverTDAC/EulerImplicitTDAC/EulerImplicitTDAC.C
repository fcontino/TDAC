...
Foam::EulerImplicitTDAC<CompType, ThermoType>::EulerImplicitTDAC
(
    TDACChemistryModel<CompType, ThermoType>& model,
    const word& modelName
)
:
    chemistrySolverTDAC<CompType, ThermoType>(model, modelName),
...
template<class CompType, class ThermoType>
Foam::scalar Foam::EulerImplicitTDAC<CompType, ThermoType>::solve
(
    scalarField &c,
    const scalar T,
    const scalar p,
